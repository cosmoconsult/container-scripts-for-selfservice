...
$useRemoteSession = $bcVersion.Major -lt 27 # For BC27 and higher, importing the BC modules fails in WinRM sessions, so we will use direct execution for the overrides instead of remote sessions.
