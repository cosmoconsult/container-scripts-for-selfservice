...
$useRemoteSession = $bcVersion.Major -lt 27 # For BC28 and higher the import of the BC modules fails in WinRM-Sessions, so we will use direct execution for the overrides instead of remote sessions.
