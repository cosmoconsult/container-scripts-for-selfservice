...
@{
    ...
    'Get-PackageVersion', 'Invoke-DownloadArtifact', 'Invoke-DownloadArtifactAsync', 'Wait-DownloadArtifactAsync', 'Invoke-DownloadArtifactInternal', 'Get-AppFilesSortedByDependencies', 'Get-ArtifactsFromEnvironment',
