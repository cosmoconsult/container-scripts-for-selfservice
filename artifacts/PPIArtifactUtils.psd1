...
@{
    ...
    'Import-FOBArtifact', 'Import-AppArtifact', 'Import-RIMArtifact', 'Import-Artifacts', 'Import-Fonts', 'Get-ArtifactJson', 'Sync-AppDependencies',
    ...
    'Install-NuGetTools', 'Initialize-NuGetFeeds', 'Import-NuGetTools', 'Resolve-NuGetArtifactsFromLocalAppFiles', 'Invoke-NuGetPackageDownload',
