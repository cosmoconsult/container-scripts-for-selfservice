...
@{
    ...
    'Get-PackageVersion', 'Invoke-DownloadArtifact', 'Invoke-DownloadArtifactAsync', 'Wait-DownloadArtifactAsync', 'Invoke-DownloadArtifactProcess', 'Get-AppFilesSortedByDependencies', 'Get-ArtifactsFromEnvironment',
