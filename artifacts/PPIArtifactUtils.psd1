...
@{
    ...
    'Get-PackageVersion', 'Invoke-DownloadArtifact', 'Start-DownloadArtifactAsync', 'Wait-DownloadArtifactAsync', 'Get-AppFilesSortedByDependencies', 'Get-ArtifactsFromEnvironment',
