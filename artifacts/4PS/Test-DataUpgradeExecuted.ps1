...
function Test-DataUpgradeExecuted {
    [cmdletbinding()]
    PARAM
    (
...
Set-Alias -Name Check-DataUpgradeExecuted -Value Test-DataUpgradeExecuted
Export-ModuleMember -Function Test-DataUpgradeExecuted -Alias Check-DataUpgradeExecuted
