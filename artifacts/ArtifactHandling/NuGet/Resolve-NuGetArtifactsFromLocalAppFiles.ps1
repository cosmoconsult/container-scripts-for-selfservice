function Resolve-NuGetArtifactsFromLocalAppFiles {
    ...
    $localAppInfos = @(Get-NuGetAppInfos -AppFilesPath $microsoftAppFilesPath -ServiceTierFolder $ServiceTierFolder -AppIds $nuGetArtifactsAppIds | Where-Object { $_.Publisher -eq 'Microsoft' })
